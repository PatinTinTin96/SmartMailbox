...
public class Buzon extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    Button btnCerrar,btnAbrir,btnDesconectar,btnSesion;
    BluetoothAdapter mBlueAdapter;
    BluetoothSocket mBlueSocket;
    TextView txtBuffer,txtEstado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {
                    ...
                    if (endOfLineIndex > 0) {
                        ...
                        txtBuffer.setText("Dato: " + dataInPrint);//<-<- PARTE A MODIFICAR >->->
        ...
        btnAbrir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtEstado.setText("Caja Abierta");
        ...
        btnCerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtEstado.setText("Caja Cerrada");
            }
        });
    }
    ...
    public void onResume()
    {
        ...
        address = intent.getStringExtra(VincularDispositivo.EXTRA_DEVICE_ADDRESS);//<-<- PARTE A MODIFICAR >->->
