...
public class DbConnection {
    ...
    public Connection conexion(){
        ...
        try{
            ...
            String url = String.format("jdbc:jtds:sqlserver://smartmailbox.database.windows.net:1433/SmartMailbox;user=Huruz;password=90637551LoL;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;");
